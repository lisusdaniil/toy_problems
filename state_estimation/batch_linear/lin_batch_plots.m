...
% MODULE:       Plot
% DESCRIPTION:  Plots the true, noisy and linear batch filtered data for the
...
plot (T,r_batch,'Color','[0.3010, 0.7450, 0.9330]','Linewidth',line_width)
%ylim([1.5,3.5])
...
grid on
grid minor
plot (T,r_true-r_batch,'k','Linewidth',line_width)
